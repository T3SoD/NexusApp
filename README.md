...
- **Opt-in updates:** Nexus asks once whether it can check GitHub for new versions. If you say yes, it checks each time Nexus starts, verifies every download, and asks before it installs anything.
