...
public sealed class GridExportDialog : Window
{
    ...
    public GridExportDialog(string shipName, string handle)
    {
        ...
        Width = 460; Height = 380; WindowStartupLocation = WindowStartupLocation.CenterOwner;
        ...
        Lbl("Notes");
        _notes.AcceptsReturn = true; _notes.Height = 110; _notes.TextWrapping = TextWrapping.Wrap;
        ...
        foreach (var tb in new[] { _handle, _summary, _notes })
        {
