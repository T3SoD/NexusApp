...
// v3 sample used by both ScmdbExportParserTests and ScmdbImportPlanTests. Embedded IN the test
// assembly and read the same way SeedTestFixture reads Data/seed_data.json from the main
